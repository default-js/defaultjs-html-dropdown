(()=>{"use strict";var t={d:(e,n)=>{for(var o in n)t.o(n,o)&&!t.o(e,o)&&Object.defineProperty(e,o,{enumerable:!0,get:n[o]})},o:(t,e)=>Object.prototype.hasOwnProperty.call(t,e),r:t=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})}},e={};t.r(e),t.d(e,{DropdownContentElement:()=>m,DropdownElement:()=>M});const n=(t,e,n)=>{Object.defineProperty(t,e,{get:n,configurable:!1,enumerable:!1})},o=()=>{let t=null,e=null;const o=new Promise(((n,o)=>{t=n,e=o}));let r,i=!1,s=!1;return((t,e,n)=>{Object.defineProperty(t,e,{value:n,writable:!1,configurable:!1,enumerable:!1})})(o,"resolve",(n=>{r=n,i=!0,r instanceof Error?(s=!0,e(r)):t(r)})),n(o,"value",(()=>r)),n(o,"error",(()=>s)),n(o,"resolved",(()=>i)),o},r=(t,e)=>{let n="unsupported";if("string"==typeof e)n=e;else if(e instanceof HTMLElement)n=e.nodeName;else{if("string"!=typeof e.NODENAME)throw new Error(typeof e+' is not supported as parameter "node"!');n=e.NODENAME}return`${n.toLowerCase()}:${t}`},i=new WeakMap,s=function(t,e,n){const o=(t=>{if(i.has(t))return i.get(t);const e={};return i.set(t,e),e})(t);if(1===arguments.length)return o;if(2===arguments.length)return o[e];if(3!==arguments.length)throw new Error("Not allowed size of arguments!");o[e]=n},a=(f="ready",function(t,e){if(2!=arguments.length)return s(t,f);s(t,f,e)}),c=new WeakMap,l=t=>class extends t{constructor({shadowRoot:t=!1,content:e=null,createUID:n=!1,uidPrefix:r="id-",uidSuffix:i=""}={}){super(),a(this,o()),n&&this.attr("id",n(r,i)),t&&this.attachShadow({mode:"open"}),e&&this.root.append("function"==typeof e?e(this):e)}get root(){return this.shadowRoot||this}get ready(){return a(this)}async init(){}async destroy(){this.ready.resolved&&a(this,o())}connectedCallback(){this.ownerDocument==document&&this.isConnected&&(t=>{let e=c.get(t);e&&clearTimeout(e),c.get(t,setTimeout((async()=>{c.delete(t);const e=a(t);try{await t.init(),e.resolve()}catch(n){console.error("Can't initialize component!",t,n),e.resolve(n)}t.trigger(r("initialzed",t))}),10))})(this)}adoptedCallback(){this.connectedCallback()}attributeChangedCallback(t,e,n){e!=n&&this.isConnected&&(this.trigger(10,r(`attribute--${t}`,this)),this.trigger(10,r("change",this)))}disconnectedCallback(){this.destroy()}},u=new Map,d=(t=>{let e=u.get(t);return null==e&&(e=l(t),u.set(t,e)),e})(HTMLElement),h=(t,e)=>"string"==typeof e?e+t:"d-"+t,p=function(t,e){const n=t.NODENAME;customElements.get(n)||customElements.define(n,t,e)},g=h("dropdown-content");var f;class m extends d{static get NODENAME(){return g}constructor(){super()}}p(m);const v=document.body,y=window.matchMedia("(any-hover: none)").matches;let w=null;const b=t=>{w&&(((t,e)=>{if(!t)return!1;const{top:n,bottom:o,left:r,right:i}=e.getDropdownContent().getBoundingClientRect(),{x:s,y:a}=t;return n<=a&&a<=o&&r<=s&&s<=i})(t,w)||(w.active=!1,w=null))};v.on("click",b);const E=h("dropdown"),D=`${m.NODENAME}, .dropdown-content`,C=`${E}--close`;class M extends d{static get NODENAME(){return E}#t=!1;#e=!1;constructor(){super(),this.root.on(C,(t=>{t.preventDefault(),t.stopPropagation(),this.active&&b()}))}async init(){if(await super.init(),!this.#t){let t=null;const e="click"==this.attr("mode")||y?"click":"mouseover";this.on(e,(e=>{const n=e.target;n.is(D)||n.parent(D)||this.active||(e.preventDefault(),e.stopPropagation(),this.active=!0),clearTimeout(t)})),y||this.on("mouseleave",(e=>{t&&clearTimeout(t),t=setTimeout((()=>{this.active&&(e.preventDefault(),e.stopPropagation(),this.active=!1),t=null}),200)}))}}getDropdownContent(){return this.root.find(D).first()}get active(){return this.#e}set active(t){t&&w!=this&&(b(),w=this),this.#e=t,this.attr("active",t?"":null)}}p(M)})();
